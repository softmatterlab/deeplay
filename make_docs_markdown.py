...
head_file = open(os.path.join(PATH_TO_SRC, deeplay.__name__ + ".rst"), "w")
...
print(get_submodules(deeplay))

for _, submodule in get_submodules(deeplay):
    ...
    submodule_path = deeplay.__name__ + "." + submodule_name
